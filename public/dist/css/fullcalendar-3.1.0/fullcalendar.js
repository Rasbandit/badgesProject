...
DragListener.mixin({
	...
	// Called when the dragging is in calendar and scrolling should be updated
...
var Grid = FC.Grid = Class.extend(ListenerMixin, MouseIgnorerMixin, {
	...
	// Kills all in-calendar dragging.
...
Grid.mixin({
	...
	bindSegHandlerToEl: function(el, name, handler) {
		...
		el.on(name, this.segSelector, function(ev) {
			...
			// only call the handlers if there is not a drag/resize in calendar
